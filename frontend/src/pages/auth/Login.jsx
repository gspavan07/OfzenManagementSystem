    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-bg-base)] p-4">
      ...
      <div className="glass-card w-full max-w-md p-8 relative z-10 animate-fade-in">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-[var(--color-text-primary)] font-display">Welcome Back</h1>
          <p className="text-sm text-[var(--color-text-muted)] mt-1">Sign in to Ofzen Management</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <Button type="submit" className="w-full justify-center py-2.5 mt-2" loading={loading} disabled={loading}>
